        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                while not self.stop_event.is_set():
                    ...
                    timestamp_blue, protocol_blue, temperature_blue, humidity_blue = data.split(',')
                    # logging.debug("vals:" + timestamp_blue + ", " + protocol_blue + ", "
                    # + temperature_blue + ", " + humidity_blue)

                    remote_entry = Entry(timestamp_blue, '14209816', protocol_blue, temperature_blue, humidity_blue)
...
class LocalSensorThread(threading.Thread):
    ...
    def run(self):
        while not self.stop_event.is_set():
            ...
            local_entry = Entry(timestamp_local, '17205685', 'RFCOMM', temperature_local, humidity_local)
